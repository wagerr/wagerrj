...
import org.wagerrj.net.*;
import org.wagerrj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of wagerrj fixes the known
     ...
     * {@link org.wagerrj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.wagerrj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.wagerrj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.wagerrj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.wagerrj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.wagerrj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.wagerrj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.wagerrj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.wagerrj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a wagerrj based app running in SPV mode to fully validating security.
     */
