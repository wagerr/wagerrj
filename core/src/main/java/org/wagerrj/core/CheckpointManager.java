...
import org.wagerrj.store.FullPrunedBlockStore;
 ...
 * {@link org.wagerrj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with wagerrj */
    ...
    /** Returns a checkpoints stream pointing to inside the wagerrj JAR */
