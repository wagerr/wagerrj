...
import org.wagerrj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.wagerr.regtest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            Script script = new ScriptBuilder().number(486604799).bigNum(4L).data("RT 15/Feb/2018 12.03 GMT - Soros brands bitcoin nest egg for dictators, but still invests in it".getBytes()).build();
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.wagerrj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.wagerrj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.wagerrj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.wagerrj.core.AlertMessage}s. You can use {@link org.wagerrj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
