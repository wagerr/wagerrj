 ...
 * the lightweight SPV mode, a {@link org.wagerrj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.wagerrj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
