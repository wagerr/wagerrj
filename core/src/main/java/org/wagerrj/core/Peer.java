...
import org.wagerrj.net.StreamConnection;
import org.wagerrj.store.BlockStore;
import org.wagerrj.store.BlockStoreException;
import org.wagerrj.utils.ListenerRegistration;
 ...
 * {@link org.wagerrj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.wagerrj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.wagerrj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.wagerrj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.wagerrj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        //main.cpp 5763     // Wagerr: We use certain sporks during IBD, so check to see if they are
...
//        }
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check wagerr masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // wagerrj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.wagerrj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.wagerrj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.wagerrj.core.Peer#ping()} has never
