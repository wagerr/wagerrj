...
import static org.wagerrj.core.Sha256Hash.*;
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link org.wagerrj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    public boolean isZerocoin() {
        if (!ACTIVATE_ZEROCOIN) {
            ...
            return version == ZEROCOIN_BLOCK_VERSION || version == 6;
        }
    }
    ...
    public static int getHeaderSizeByVersion(long version){
        if (!ACTIVATE_ZEROCOIN) {
            ...
            return Block.ZEROCOIN_BLOCK_VERSION == version || version == 6   ? ZEROCOIN_HEADER_SIZE : HEADER_SIZE;
        }
    }
     ...
     * {@link org.wagerrj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
