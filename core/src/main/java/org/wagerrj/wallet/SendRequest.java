...
import org.wagerrj.wallet.KeyChain.KeyPurpose;
import org.wagerrj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.wagerrj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.wagerrj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
