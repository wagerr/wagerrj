...
import org.wagerrj.core.BloomFilter;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.wagerrj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.wagerrj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.wagerrj.crypto.KeyCrypter,
