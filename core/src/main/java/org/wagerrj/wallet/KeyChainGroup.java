...
/**
 * <p>A KeyChainGroup is used by the {@link org.wagerrj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.wagerrj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.wagerrj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.wagerrj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
