...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.wagerrj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.wagerrj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.wagerrj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
