...
import org.wagerrj.core.Message;
import org.wagerrj.core.listeners.*;
import org.wagerrj.core.TransactionConfidence.*;
import org.wagerrj.crypto.*;
import org.wagerrj.script.*;
import org.wagerrj.signers.*;
import org.wagerrj.utils.*;
import org.wagerrj.wallet.Protos.Wallet.*;
import org.wagerrj.wallet.WalletTransaction.*;
import org.wagerrj.wallet.listeners.KeyChainEventListener;
import org.wagerrj.wallet.listeners.ScriptsChangeEventListener;
import org.wagerrj.wallet.listeners.WalletChangeEventListener;
import org.wagerrj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.wagerrj.wallet.listeners.WalletCoinsSentEventListener;
import org.wagerrj.wallet.listeners.WalletEventListener;
import org.wagerrj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.wagerrj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_wagerr_ONLY? 1 : 0;
     ...
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.wagerrj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.wagerrj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.wagerrj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.wagerrj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.wagerrj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.wagerrj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.wagerrj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.wagerrj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of wagerrj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.wagerrj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.wagerrj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.wagerrj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.wagerrj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.wagerrj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.wagerrj.crypto.KeyCrypter,
     ...
     * {@link org.wagerrj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.wagerrj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.wagerrj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.wagerrj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.wagerrj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.wagerrj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
