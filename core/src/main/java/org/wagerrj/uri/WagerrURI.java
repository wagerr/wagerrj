...
import org.wagerrj.params.AbstractBitcoinNetParams;
...
public class WagerrURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.wagerrj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.wagerrj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new wagerrURI from the given string. Can be for any network.
     *
     ...
     */
    public WagerrURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public WagerrURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("wagerrURI[");
        boolean first = true;
