...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.wagerrj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
    ...
    public static DeterministicKey deserializeB58(@Nullable DeterministicKey parent, String base58, NetworkParameters params) {
        return deserialize(params, Base58.decodeChecked(base58), parent, DeterministicKeyChain.KeyChainType.BIP44_WAGERR_ONLY);
    }
    ...
    public static DeterministicKey deserialize(NetworkParameters params, byte[] serializedKey) {
        return deserialize(params, serializedKey, null, DeterministicKeyChain.KeyChainType.BIP44_WAGERR_ONLY);
    }
    ...
    public static DeterministicKey deserialize(NetworkParameters params, byte[] serializedKey, @Nullable DeterministicKey parent, DeterministicKeyChain.KeyChainType keyChainType) {
        ...
        if (parent != null) {
            ...
            if (depth >= 1)
                ...
                // parent's node.
                if (keyChainType == DeterministicKeyChain.KeyChainType.BIP44_WAGERR_ONLY){
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.wagerrj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
