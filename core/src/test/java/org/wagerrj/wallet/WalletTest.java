...
import org.wagerrj.core.AbstractBlockChain;
...
import org.wagerrj.core.PeerAddress;
...
import org.wagerrj.signers.StatelessTransactionSigner;
import org.wagerrj.signers.TransactionSigner;
import org.wagerrj.store.BlockStoreException;
import org.wagerrj.store.MemoryBlockStore;
import org.wagerrj.testing.*;
import org.wagerrj.utils.ExchangeRate;
import org.wagerrj.utils.Fiat;
...
import org.wagerrj.wallet.Protos.Wallet.EncryptionType;
...
import static org.wagerrj.core.Utils.HEX;
import static org.wagerrj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: wagerrj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("wagerrj-unit-test", null);
