...
import org.wagerrj.testing.TestWithWallet;
...
import static org.wagerrj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.wagerrj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.wagerrj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
