...
package org.wagerrj.tools;

import org.wagerrj.core.*;
import org.wagerrj.crypto.*;
import org.wagerrj.net.discovery.DnsDiscovery;
import org.wagerrj.params.MainNetParams;
import org.wagerrj.params.RegTestParams;
import org.wagerrj.params.TestNet3Params;
import org.wagerrj.protocols.payments.PaymentProtocol;
import org.wagerrj.protocols.payments.PaymentProtocolException;
import org.wagerrj.protocols.payments.PaymentSession;
import org.wagerrj.script.ScriptBuilder;
import org.wagerrj.store.*;
import org.wagerrj.uri.WagerrURI;
import org.wagerrj.uri.BitcoinURIParseException;
import org.wagerrj.utils.BriefLogFormatter;
import org.wagerrj.wallet.DeterministicSeed;
import org.wagerrj.wallet.DeterministicUpgradeRequiredException;
import org.wagerrj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.wagerrj.core.listeners.BlocksDownloadedEventListener;
import org.wagerrj.core.listeners.DownloadProgressTracker;
import org.wagerrj.wallet.MarriedKeyChain;
import org.wagerrj.wallet.Protos;
import org.wagerrj.wallet.SendRequest;
import org.wagerrj.wallet.Wallet;
import org.wagerrj.wallet.WalletExtension;
import org.wagerrj.wallet.WalletProtobufSerializer;
import org.wagerrj.wallet.Wallet.BalanceType;
...
import static org.wagerrj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    WagerrURI paymentRequestURI = new WagerrURI(location);
